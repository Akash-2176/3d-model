...
export function Home(props) {
  ...
  useFrame(() => {
    if (groupRef.current) {
      ...
      const targetX = -y * Math.PI * 0.25; // Invert the Y-axis rotation
      const targetY = x * Math.PI * 0.5;  // Rotate normally on the X-axis
  ...
  return (
    <group ref={groupRef} {...props} dispose={null} position={[0, -2, -3]} scale={[2, 2, 2]}>
      <mesh
